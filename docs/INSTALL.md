...
It is recommended to use the provided INSTALL.sh script. If you wish to install manually, however, please keep reading. If you use the INSTALL.sh script, skip to [Logging in for the first time](#step-6---logging-in-for-the-first-time)
